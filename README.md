...
Then, simply run each part 1 file from within the `llm_extractinator` folder and run the llm_extractinator as instructed via the displayed output. Afterwards, run the `part2.py` files to collect and aggregate the results.
